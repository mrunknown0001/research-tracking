  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('dr.proceed.step.six') }}" method="POST">
          {{ csrf_field() }}
          <div class="form-group">
            <input type="number" name="grade" id="grade" max="100" class="form-control" placeholder="Colloquium Grade" required>
          </div>
          <div class="form-group">
